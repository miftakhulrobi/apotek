                ...
                <ul class="navbar-nav navbar-nav-right">
                    <li class="nav-item dropdown d-none d-xl-inline-block">
                        ...
                        <div class="dropdown-menu dropdown-menu-right navbar-dropdown" aria-labelledby="UserDropdown">
                            ...
                            <a href="<?= base_url('profile_p') ?>" class="dropdown-item">
                                Profile Saya
                            </a>
                ...
                <ul class="nav">
                    <li class="nav-item nav-profile">
                        <div class="nav-link">
                            ...
                            <a href="<?= base_url('transaction_p') ?>" class="btn btn-success btn-block btn-hover">Transaksi Baru
                                <i class="mdi mdi-plus"></i>
                            </a>
                        </div>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="<?= base_url('dashboard_p') ?>">
